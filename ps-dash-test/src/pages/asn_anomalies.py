...
from model.queries import query_ASN_anomalies #requires connecting to Elasticsearch which disables isolated testing of function without launching the webapp
...
def generate_plotly_heatmap_with_anomalies(subset_sample):
    try:
        ...
        return fig
    except Exception as err: #Exception added to track if data from query_ASN_anomalies is different from expected
        return err